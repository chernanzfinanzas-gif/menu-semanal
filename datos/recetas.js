...
{
  id:"pan_tostado_mesa", n:"Pan de mesa (panecillo sin sal)",
  rev:2,
  tipo:["comida","cena"], grupo:"desayuno", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pan_panecillo_sinsal",c:1}],
  pasos:[
    "Un panecillo sin sal, en la mesa, con la comida y con la cena."
  ],
  trucos:[
    "ESTE ERA EL PROBLEMA DE TU DÍA Y YA NO LO ES. Las tres rebanadas de Ortiz eran 0,45 g de sal por toma y 0,91 g al día: más que todo el resto del menú junto. Un panecillo sin sal lleva 0,007 g. Sesenta y cinco veces menos.",
    "Al día: pasas de 0,91 g de sal a 0,014. Te ahorras casi un gramo entero, que es el 22% de tu tope.",
    "EL PEAJE SON CALORÍAS: el panecillo de 70 g son 222 kcal y las tres rebanadas eran 129. Dos tomas al día son 185 kcal más. Si el déficit se resiente, la solución no es volver al Ortiz: es medio panecillo (111 kcal), que sigue siendo menos que las tres rebanadas y la sal sigue siendo despreciable.",
    "De propina, más proteína: 6,8 g el panecillo frente a 3,6 g de las tres rebanadas.",
    "El Ortiz no ha desaparecido: sigue en el catálogo y tiene su propia receta, «Pan tostado Ortiz (3 rebanadas)», por si algún día lo quieres."
  ],
  nota:"Fijo en comida y cena, igual que el yogur con avena. Sustituyó al pan Ortiz el 22-sep-2026 conservando el mismo id, para que el cambio entrara solo en todos los días ya planificados."
   ...
   quedarse corto. */
{
  ...
  rev:2, llevable:true, tanda:true,
...
,
{
  id:"cap_bk_alita", n:"Alita de pollo de Burger King (una)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"bk_alita",c:1}],
  pasos:["Una alita. Sube el contador con las que te comas."],
  trucos:[
    "79 kcal y 0,78 g de sal POR ALITA. Con el contador del menú pones las que sean.",
    "Las cuentas que importan: 3 alitas son 2,3 g de sal (el 58% de tu tope del día) y 6 alitas son 4,7 g, o sea TODO tu día de sal en un solo plato.",
    "Con 2 g de sal por 100 g son lo más salado de la carta de Burger King, ocho veces más saladas que los aros de cebolla.",
    "8,3 g de proteína por alita, eso sí. La carne está bien; el problema es el rebozado y la salsa.",
    "Dato oficial de Burger King España (presentaciones de 3 y de 6, que cuadran entre sí)."
  ]
},
{
  id:"cap_pistachos", n:"Pistachos con sal (un puñado, 30 g de grano)",
  rev:1,
  tipo:["almuerzo","merienda"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pistachos_sal",c:30}],
  pasos:["Un puñado, 30 g ya pelados. Con cáscara serían unos 57 g."],
  trucos:[
    "185 kcal y 0,24 g de sal el puñado. 7,5 g de proteína, que para un snack está muy bien.",
    "Los mismos 30 g de los 0% sal son 185 kcal y CERO sal. Mismo sabor a pistacho, mismo precio aproximado: es el cambio más barato que puedes hacer.",
    "OJO con la marca: la sal de los pistachos salados va de 0,7 a 3,2 g por 100 g según el fabricante. Con los peores, el puñado se te va a 1 g de sal.",
    "100 g con cáscara son unos 53 g de grano. Si compras con cáscara, cuenta casi la mitad."
  ]
},
{
  id:"cap_mango_deshidratado", n:"Mango deshidratado (un puñado, 30 g)",
  rev:1,
  tipo:["almuerzo","merienda"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"mango_deshidratado",c:30}],
  pasos:["Un puñado, 30 g."],
  trucos:[
    "95 kcal y 0,07 g de sal. Sin azúcar añadido, pero 19 g de azúcar propio del mango en el puñado: al secarlo se concentra.",
    "Para comparar: un mango fresco entero tiene los mismos azúcares repartidos en 200 g de fruta con agua. Deshidratado se come mucho más rápido.",
    "De sal no tiene ningún problema. El aviso es solo por el azúcar."
  ]
},
{
  id:"cap_zumo_granini", n:"Néctar de naranja Granini (brick de 200 ml)",
  rev:1,
  tipo:["desayuno","almuerzo","merienda"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"zumo_granini",c:200}],
  pasos:["Un brick pequeño, 200 ml."],
  trucos:[
    "82 kcal y 18,4 g de azúcar el brick. Cero sal: por tu oído no hay ningún problema.",
    "No es zumo exprimido: es NÉCTAR, de concentrado, con un 50% de fruta y azúcar añadido. La etiqueta lo dice en pequeño.",
    "18,4 g de azúcar son casi los mismos que una lata de refresco con azúcar. Si el objetivo es bajar peso, este es de los que engañan."
  ]
},

{
  id:"cap_cerveza", n:"Cerveza (un tercio, 330 ml)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"cerveza",c:330}],
  pasos:["Un tercio, 330 ml. Para una caña pon 200 ml o baja el contador a media."],
  trucos:[
    "155 kcal y CERO sal. Por tu oído la cerveza no es un problema: no lleva sodio apreciable.",
    "El precio son las calorías, y casi todas vienen del alcohol: 14 g de alcohol por tercio, que son unas 100 de esas 155 kcal.",
    "Tres tercios en una comida con amigos son 465 kcal, un cuarto de tu día, sin haber comido nada.",
    "La 0,0 son 69 kcal el tercio: menos de la mitad, y tampoco tiene sal."
  ]
},
{
  id:"cap_cerveza_sin", n:"Cerveza sin alcohol (un tercio, 330 ml)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"cerveza_sin",c:330}],
  pasos:["Un tercio de 0,0."],
  trucos:["69 kcal y cero sal. Menos de la mitad que la normal (155). Si la comida con amigos va larga, es la que deja el día entero libre."]
},
{
  id:"cap_fanta_naranja_zero", n:"Fanta Naranja Zero (lata de 330 ml)",
  rev:1,
  tipo:["comida","cena","almuerzo","merienda"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"fanta_nar_zero",c:330}],
  pasos:["Una lata."],
  trucos:["10 kcal y 0,07 g de sal. Prácticamente no cuenta en ninguna de las dos cuentas."]
},
{
  id:"cap_fanta_limon_zero", n:"Fanta Limón Zero (lata de 330 ml)",
  rev:1,
  tipo:["comida","cena","almuerzo","merienda"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"fanta_lim_zero",c:330}],
  pasos:["Una lata."],
  trucos:[
    "7 kcal y 0,20 g de sal. Es poco, pero es TRES VECES la sal de la Coca-Cola Zero o la Fanta de naranja.",
    "No son intercambiables: si bebes varias al día, la de limón suma y las otras no."
  ]
},
{
  id:"cap_pj_pan_ajo", n:"Pan de ajo con mozzarella de Papa John's (ración)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pj_pan_ajo",c:150}],
  pasos:["Una ración. Los 150 g son una estimación: Papa John's no publica el peso."],
  trucos:[
    "348 kcal y 0,71 g de sal la ración estimada.",
    "Es el entrante MENOS salado de su carta: 0,47 g por 100 g, casi cuatro veces menos que los palitos de mozzarella (1,80). Contraintuitivo y es el dato oficial.",
    "Si vas a pedir un entrante en Papa John's, este es el que menos te cuesta en sal."
  ]
},
{
  id:"cap_pj_mozza_sticks", n:"Palitos de mozzarella de Papa John's (ración)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pj_mozza_sticks",c:120}],
  pasos:["Una ración. Los 120 g son una estimación: Papa John's no publica el peso."],
  trucos:[
    "338 kcal y 2,16 g de sal la ración estimada: más de la mitad de tu día.",
    "1,8 g de sal por 100 g, el entrante más salado de su carta.",
    "El pan de ajo con mozzarella lleva el mismo queso y un tercio de la sal."
  ]
},
{
  id:"cap_pj_alitas", n:"Alitas de pollo de Papa John's (ración)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pj_alitas",c:150}],
  pasos:["Una ración. Los 150 g son una estimación: Papa John's no publica el peso."],
  trucos:[
    "315 kcal y 2,06 g de sal la ración estimada. 34 g de proteína.",
    "Para comparar: las de Burger King son 0,78 g de sal POR ALITA, o sea 2,3 g sólo tres. Las dos cadenas están en el mismo sitio: muy saladas."
  ]
},
{
  id:"cap_pj_patatas", n:"Papas de Papa John's (ración)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pj_patatas",c:150}],
  pasos:["Una ración. Los 150 g son una estimación: Papa John's no publica el peso."],
  trucos:["213 kcal y 1,8 g de sal la ración estimada. Ojo: 1,2 g por 100 g es de lo más salado de su carta, más que sus propios aros de cebolla."]
},
{
  id:"cap_pj_chococookie", n:"ChocoCookie de Papa John's",
  rev:1,
  tipo:["postre","merienda"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pj_chococookie",c:100}],
  pasos:["Una ChocoCookie. Los 100 g son una estimación: Papa John's no publica el peso."],
  trucos:["451 kcal y 0,84 g de sal por 100 g, con 34 g de azúcar. Es el postre más caro en calorías de las cadenas que llevas."]
},
{
  id:"cap_tapa_oreja", n:"Oreja a la plancha (un cuarto de ración)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"tapa_oreja",c:50}],
  pasos:["Lo que te toca si la ración se reparte entre cuatro: unos 50 g."],
  trucos:[
    "105 kcal y 0,71 g de sal tu cuarto. La ración entera son 420 kcal y unos 2,8 g de sal.",
    "CIFRA ESTIMADA, no de etiqueta: la oreja de bar no lleva ninguna. El rango real de la ración va de 1,8 a 4,3 g de sal según cómo venga adobada.",
    "Casi toda la sal la pone el bar, no el alimento: la oreja cocida tiene 0,42 g por 100 g y el plato acaba en 1,4."
  ]
},
{
  id:"cap_tapa_bravas", n:"Patatas bravas (un cuarto de ración)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"tapa_bravas",c:75}],
  pasos:["Lo que te toca si la ración se reparte entre cuatro: unos 75 g."],
  trucos:[
    "144 kcal y 0,77 g de sal tu cuarto. La ración entera, 577 kcal y unos 3 g de sal.",
    "CIFRA ESTIMADA. Y es la de rango más ancho de todas: de 1,5 a 6 g de sal en la ración, según el bar.",
    "El culpable es la SALSA, no la patata: las salsas bravas comerciales van de 1,1 a 4,9 g de sal por 100 g. Pedir la salsa aparte y mojar poco es lo único que mueve de verdad este número."
  ]
},
{
  id:"cap_tapa_calamares", n:"Calamares a la romana (un cuarto de ración)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"tapa_calamares",c:62}],
  pasos:["Lo que te toca si la ración se reparte entre cuatro: unos 62 g."],
  trucos:[
    "174 kcal y 0,83 g de sal tu cuarto. La ración entera, 703 kcal y unos 3,3 g de sal.",
    "CIFRA ESTIMADA, pero de las más firmes de las cinco: el 82% de la sal viene del rebozado industrial, que sí tiene etiqueta (1,25 g/100 g).",
    "Aquí quitar el salero no sirve de nada: la sal ya viene puesta de fábrica."
  ]
},
{
  id:"cap_tapa_croqueta", n:"Croqueta de jamón de bar (una)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"tapa_croqueta",c:1}],
  pasos:["Una croqueta. Sube el contador con las que te comas."],
  trucos:[
    "87 kcal y 0,34 g de sal POR CROQUETA. Seis son 522 kcal y 2 g de sal.",
    "CIFRA ESTIMADA, pero es la mejor anclada de las tapas: cuadra con lo que midió AESAN en croquetas en España (1,3 g de sal por 100 g).",
    "Sorpresa: de las cinco tapas de bar, las croquetas fritas son LAS QUE MENOS SAL traen. Parecen lo peor y no lo son."
  ]
},
{
  id:"cap_tapa_sepia", n:"Sepia a la plancha (un cuarto de ración)",
  rev:1,
  tipo:["comida","cena","almuerzo"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"tapa_sepia",c:47}],
  pasos:["Lo que te toca si la ración se reparte entre cuatro: unos 47 g."],
  trucos:[
    "75 kcal y 1,07 g de sal tu cuarto. La ración entera, 304 kcal y unos 4,3 g de sal.",
    "ES LA TAPA MÁS SALADA DE LAS CINCO, y parece la más sana: poca grasa, 40 g de proteína la ración. Justo por eso conviene saberlo.",
    "La mitad de esa sal no la pone el bar: LA SEPIA YA TRAE 0,93 g por 100 g de origen, como todos los moluscos de mar. Pedir que no la salen ayuda, pero no la deja limpia.",
    "CIFRA ESTIMADA. Rango de la ración: de 3,3 a 5,8 g de sal."
  ]
}
,

{
  id:"cap_pizza_pepperoni", n:"Media pizza mediana de pepperoni (restaurante)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pizza_pepperoni",c:232}],
  pasos:["Media pizza mediana: 4 de las 8 porciones, unos 232 g."],
  trucos:[
    "541 kcal y 3,0 g de sal la media pizza. Los 3 g son el 75% de tu tope del día.",
    "Por porción: 135 kcal y 0,75 g de sal. Con dos porciones ya vas por 1,5 g.",
    "APROXIMACIÓN, no dato español: sale de la tabla oficial de Domino's PORTUGAL, porque la española no se puede consultar. El mismo producto varía bastante entre países.",
    "De las tres pizzas de restaurante que tienes, esta es la más salada."
  ]
},
{
  id:"cap_pizza_bbq", n:"Media pizza mediana barbacoa con pollo (restaurante)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pizza_bbq_pollo",c:262}],
  pasos:["Media pizza mediana: 4 de las 8 porciones, unos 262 g."],
  trucos:[
    "516 kcal y 2,6 g de sal la media pizza.",
    "Es la menos mala de las tres en las dos cuentas: menos grasa (5,2 g/100 g frente a 10,9 de la carbonara) y menos sal que la de pepperoni.",
    "A cambio lleva más azúcar, de la salsa barbacoa: 6,5 g por 100 g.",
    "APROXIMACIÓN de la tabla oficial de Domino's Portugal, no dato español."
  ]
},
{
  id:"cap_pizza_carbonara", n:"Media pizza mediana carbonara (restaurante)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pizza_carbonara",c:262}],
  pasos:["Media pizza mediana: 4 de las 8 porciones, unos 262 g."],
  trucos:[
    "597 kcal y 2,4 g de sal la media pizza. La menos salada de las tres, pero la que más calorías tiene.",
    "APROXIMACIÓN de la tabla oficial de Domino's Portugal, no dato español."
  ]
}
,

/* ================= PIZZAS DR. OETKER, media pizza ================= */
{
  id:"cap_do_ristorante_quattro_formaggi", n:"Media pizza Ristorante Quattro Formaggi (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_quattro_formaggi",c:170}],
  pasos:[
    "Media pizza: 170 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "437 kcal y 1.7 g de sal la media pizza. Son el 25% de tus calorías del día y el 42% de tu tope de sal.",
    "La pizza entera (340 g) son 874 kcal y 3.4 g de sal: te pasarías del día de sal tú solo.",
    "19 g de proteína en la media pizza, que no está mal.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_ristorante_barbacoa", n:"Media pizza Ristorante Barbacoa (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_barbacoa",c:170}],
  pasos:[
    "Media pizza: 170 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "401 kcal y 2.21 g de sal la media pizza. Son el 23% de tus calorías del día y el 55% de tu tope de sal.",
    "La pizza entera (340 g) son 802 kcal y 4.42 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_ristorante_pepperoni_salame", n:"Media pizza Ristorante Pepperoni-Salame (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_pepperoni_salame",c:160}],
  pasos:[
    "Media pizza: 160 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "419 kcal y 2.08 g de sal la media pizza. Son el 24% de tus calorías del día y el 52% de tu tope de sal.",
    "La pizza entera (320 g) son 838 kcal y 4.16 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
...
{
  id:"cap_do_ristorante_prosciutto", n:"Media pizza Ristorante Prosciutto (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_prosciutto",c:170}],
  pasos:[
    "Media pizza: 170 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "391 kcal y 2.04 g de sal la media pizza. Son el 22% de tus calorías del día y el 51% de tu tope de sal.",
    "La pizza entera (340 g) son 782 kcal y 4.08 g de sal: te pasarías del día de sal tú solo.",
    "17 g de proteína en la media pizza, que no está mal.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_ristorante_hawaii", n:"Media pizza Ristorante Hawaii (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_hawaii",c:177.5}],
  pasos:[
    "Media pizza: 177.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "387 kcal y 1.77 g de sal la media pizza. Son el 22% de tus calorías del día y el 44% de tu tope de sal.",
    "La pizza entera (355 g) son 774 kcal y 3.55 g de sal: te pasarías del día de sal tú solo.",
    "15 g de proteína en la media pizza, que no está mal.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_ristorante_mozzarella", n:"Media pizza Ristorante Mozzarella (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_mozzarella",c:177.5}],
  pasos:[
    "Media pizza: 177.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "431 kcal y 1.77 g de sal la media pizza. Son el 24% de tus calorías del día y el 44% de tu tope de sal.",
    "La pizza entera (355 g) son 863 kcal y 3.55 g de sal: te pasarías del día de sal tú solo.",
    "18 g de proteína en la media pizza, que no está mal.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_ristorante_vegetale", n:"Media pizza Ristorante Vegetale (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_vegetale",c:192.5}],
  pasos:[
    "Media pizza: 192.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "358 kcal y 1.87 g de sal la media pizza. Son el 20% de tus calorías del día y el 47% de tu tope de sal.",
    "La pizza entera (385 g) son 716 kcal y 3.73 g de sal: te pasarías del día de sal tú solo.",
    "Con 0.97 g de sal por 100 g es de las MENOS saladas del catálogo de Dr. Oetker. Ninguna baja de 0,89.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_ristorante_pollo", n:"Media pizza Ristorante Pollo (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_pollo",c:177.5}],
  pasos:[
    "Media pizza: 177.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "369 kcal y 1.77 g de sal la media pizza. Son el 21% de tus calorías del día y el 44% de tu tope de sal.",
    "La pizza entera (355 g) son 738 kcal y 3.55 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_ristorante_tonno", n:"Media pizza Ristorante Tonno (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_tonno",c:177.5}],
  pasos:[
    "Media pizza: 177.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "412 kcal y 1.67 g de sal la media pizza. Son el 23% de tus calorías del día y el 42% de tu tope de sal.",
    "La pizza entera (355 g) son 824 kcal y 3.34 g de sal: te pasarías del día de sal tú solo.",
    "18 g de proteína en la media pizza, que no está mal.",
    "Con 0.94 g de sal por 100 g es de las MENOS saladas del catálogo de Dr. Oetker. Ninguna baja de 0,89.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_ristorante_speciale", n:"Media pizza Ristorante Speciale (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_speciale",c:172.5}],
  pasos:[
    "Media pizza: 172.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "405 kcal y 2.24 g de sal la media pizza. Son el 23% de tus calorías del día y el 56% de tu tope de sal.",
    "La pizza entera (345 g) son 811 kcal y 4.49 g de sal: te pasarías del día de sal tú solo.",
    "17 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
...
{
  id:"cap_do_ristorante_funghi", n:"Media pizza Ristorante Funghi (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_funghi",c:182.5}],
  pasos:[
    "Media pizza: 182.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "405 kcal y 1.75 g de sal la media pizza. Son el 23% de tus calorías del día y el 44% de tu tope de sal.",
    "La pizza entera (365 g) son 810 kcal y 3.5 g de sal: te pasarías del día de sal tú solo.",
    "Con 0.96 g de sal por 100 g es de las MENOS saladas del catálogo de Dr. Oetker. Ninguna baja de 0,89.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_ristorante_diavola", n:"Media pizza Ristorante Diavola (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_diavola",c:175}],
  pasos:[
    "Media pizza: 175 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "413 kcal y 2.27 g de sal la media pizza. Son el 23% de tus calorías del día y el 57% de tu tope de sal.",
    "La pizza entera (350 g) son 826 kcal y 4.55 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
...
{
  id:"cap_do_ristorante_spinaci", n:"Media pizza Ristorante Spinaci (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_spinaci",c:195}],
  pasos:[
    "Media pizza: 195 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "431 kcal y 1.91 g de sal la media pizza. Son el 24% de tus calorías del día y el 48% de tu tope de sal.",
    "La pizza entera (390 g) son 862 kcal y 3.82 g de sal: te pasarías del día de sal tú solo.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_ristorante_rucola", n:"Media pizza Ristorante Rucola (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_rucola",c:162.5}],
  pasos:[
    "Media pizza: 162.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "343 kcal y 1.45 g de sal la media pizza. Son el 19% de tus calorías del día y el 36% de tu tope de sal.",
    "La pizza entera (325 g) son 686 kcal y 2.89 g de sal: te pasarías del día de sal tú solo.",
    "Con 0.89 g de sal por 100 g es de las MENOS saladas del catálogo de Dr. Oetker. Ninguna baja de 0,89.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_ristorante_bolognese", n:"Media pizza Ristorante Bolognese (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_bolognese",c:187.5}],
  pasos:[
    "Media pizza: 187.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "386 kcal y 1.88 g de sal la media pizza. Son el 22% de tus calorías del día y el 47% de tu tope de sal.",
    "La pizza entera (375 g) son 772 kcal y 3.75 g de sal: te pasarías del día de sal tú solo.",
    "15 g de proteína en la media pizza, que no está mal.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_ristorante_carbonara", n:"Media pizza Ristorante Carbonara (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_carbonara",c:170}],
  pasos:[
    "Media pizza: 170 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "411 kcal y 2.21 g de sal la media pizza. Son el 23% de tus calorías del día y el 55% de tu tope de sal.",
    "La pizza entera (340 g) son 823 kcal y 4.42 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
...
{
  id:"cap_do_ristorante_salame_mozzarella_pesto", n:"Media pizza Ristorante Salame Mozzarella Pesto (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_salame_mozzarella_pesto",c:180}],
  pasos:[
    "Media pizza: 180 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "441 kcal y 2.16 g de sal la media pizza. Son el 25% de tus calorías del día y el 54% de tu tope de sal.",
    "La pizza entera (360 g) son 882 kcal y 4.32 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_ristorante_al_salame_vegano", n:"Media pizza Ristorante al Salame Vegano (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_al_salame_vegano",c:147.5}],
  pasos:[
    "Media pizza: 147.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "355 kcal y 1.62 g de sal la media pizza. Son el 20% de tus calorías del día y el 41% de tu tope de sal.",
    "La pizza entera (295 g) son 711 kcal y 3.25 g de sal: te pasarías del día de sal tú solo.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_ristorante_salame_sin_gluten", n:"Media pizza Ristorante Salame sin gluten (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_salame_sin_gluten",c:157.5}],
  pasos:[
    "Media pizza: 157.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "383 kcal y 2.21 g de sal la media pizza. Son el 22% de tus calorías del día y el 55% de tu tope de sal.",
    "La pizza entera (315 g) son 765 kcal y 4.41 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Con 1.4 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_ristorante_mozzarella_sin_gluten", n:"Media pizza Ristorante Mozzarella sin gluten (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_mozzarella_sin_gluten",c:185}],
  pasos:[
    "Media pizza: 185 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "411 kcal y 1.72 g de sal la media pizza. Son el 23% de tus calorías del día y el 43% de tu tope de sal.",
    "La pizza entera (370 g) son 821 kcal y 3.44 g de sal: te pasarías del día de sal tú solo.",
    "18 g de proteína en la media pizza, que no está mal.",
    "Con 0.93 g de sal por 100 g es de las MENOS saladas del catálogo de Dr. Oetker. Ninguna baja de 0,89.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_ristorante_prosciutto_sin_gluten", n:"Media pizza Ristorante Prosciutto sin gluten (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_ristorante_prosciutto_sin_gluten",c:172.5}],
  pasos:[
    "Media pizza: 172.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "381 kcal y 2.24 g de sal la media pizza. Son el 21% de tus calorías del día y el 56% de tu tope de sal.",
    "La pizza entera (345 g) son 762 kcal y 4.49 g de sal: te pasarías del día de sal tú solo.",
    "19 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
...
{
  id:"cap_do_casa_di_mama_4_formaggi", n:"Media pizza Casa di Mama 4 Formaggi (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_casa_di_mama_4_formaggi",c:205}],
  pasos:[
    "Media pizza: 205 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "433 kcal y 2.46 g de sal la media pizza. Son el 24% de tus calorías del día y el 62% de tu tope de sal.",
    "La pizza entera (410 g) son 865 kcal y 4.92 g de sal: te pasarías del día de sal tú solo.",
    "19 g de proteína en la media pizza, que no está mal.",
    "Ojo con la gama: Casa di Mama y La Mia Grande pesan más que las Ristorante, así que aunque la sal por 100 g sea parecida, la media pizza siempre pasa de 2,2 g.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_casa_di_mama_bbq_pulled_pork", n:"Media pizza Casa di Mama BBQ Pulled Pork (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_casa_di_mama_bbq_pulled_pork",c:202.5}],
  pasos:[
    "Media pizza: 202.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "397 kcal y 2.43 g de sal la media pizza. Son el 22% de tus calorías del día y el 61% de tu tope de sal.",
    "La pizza entera (405 g) son 794 kcal y 4.86 g de sal: te pasarías del día de sal tú solo.",
    "18 g de proteína en la media pizza, que no está mal.",
    "Ojo con la gama: Casa di Mama y La Mia Grande pesan más que las Ristorante, así que aunque la sal por 100 g sea parecida, la media pizza siempre pasa de 2,2 g.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
...
{
  id:"cap_do_casa_di_mama_speciale", n:"Media pizza Casa di Mama Speciale (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_casa_di_mama_speciale",c:207.5}],
  pasos:[
    "Media pizza: 207.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "419 kcal y 2.7 g de sal la media pizza. Son el 24% de tus calorías del día y el 67% de tu tope de sal.",
    "La pizza entera (415 g) son 838 kcal y 5.39 g de sal: te pasarías del día de sal tú solo.",
    "19 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Ojo con la gama: Casa di Mama y La Mia Grande pesan más que las Ristorante, así que aunque la sal por 100 g sea parecida, la media pizza siempre pasa de 2,2 g.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
...
{
  id:"cap_do_casa_di_mama_tonno", n:"Media pizza Casa di Mama Tonno (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_casa_di_mama_tonno",c:217.5}],
  pasos:[
    "Media pizza: 217.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "405 kcal y 2.39 g de sal la media pizza. Son el 23% de tus calorías del día y el 60% de tu tope de sal.",
    "La pizza entera (435 g) son 809 kcal y 4.79 g de sal: te pasarías del día de sal tú solo.",
    "20 g de proteína en la media pizza, que no está mal.",
    "Ojo con la gama: Casa di Mama y La Mia Grande pesan más que las Ristorante, así que aunque la sal por 100 g sea parecida, la media pizza siempre pasa de 2,2 g.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_casa_di_mama_bolognese", n:"Media pizza Casa di Mama Bolognese (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_casa_di_mama_bolognese",c:210}],
  pasos:[
    "Media pizza: 210 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "386 kcal y 2.52 g de sal la media pizza. Son el 22% de tus calorías del día y el 63% de tu tope de sal.",
    "La pizza entera (420 g) son 773 kcal y 5.04 g de sal: te pasarías del día de sal tú solo.",
    "17 g de proteína en la media pizza, que no está mal.",
    "Ojo con la gama: Casa di Mama y La Mia Grande pesan más que las Ristorante, así que aunque la sal por 100 g sea parecida, la media pizza siempre pasa de 2,2 g.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
...
{
  id:"cap_do_casa_di_mama_prosciutto_funghi", n:"Media pizza Casa di Mama Prosciutto-Funghi (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_casa_di_mama_prosciutto_funghi",c:202.5}],
  pasos:[
    "Media pizza: 202.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "375 kcal y 2.43 g de sal la media pizza. Son el 21% de tus calorías del día y el 61% de tu tope de sal.",
    "La pizza entera (405 g) son 749 kcal y 4.86 g de sal: te pasarías del día de sal tú solo.",
    "17 g de proteína en la media pizza, que no está mal.",
    "Ojo con la gama: Casa di Mama y La Mia Grande pesan más que las Ristorante, así que aunque la sal por 100 g sea parecida, la media pizza siempre pasa de 2,2 g.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
...
{
  id:"cap_do_tradizionale_quattro_formaggi", n:"Media pizza Tradizionale Quattro Formaggi (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_tradizionale_quattro_formaggi",c:190}],
  pasos:[
    "Media pizza: 190 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "464 kcal y 1.9 g de sal la media pizza. Son el 26% de tus calorías del día y el 48% de tu tope de sal.",
    "La pizza entera (380 g) son 927 kcal y 3.8 g de sal: te pasarías del día de sal tú solo.",
    "19 g de proteína en la media pizza, que no está mal.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_tradizionale_diavola_calabrese", n:"Media pizza Tradizionale Diavola Calabrese (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_tradizionale_diavola_calabrese",c:180}],
  pasos:[
    "Media pizza: 180 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "414 kcal y 2.34 g de sal la media pizza. Son el 23% de tus calorías del día y el 58% de tu tope de sal.",
    "La pizza entera (360 g) son 828 kcal y 4.68 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
...
{
  id:"cap_do_tradizionale_speciale", n:"Media pizza Tradizionale Speciale (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_tradizionale_speciale",c:200}],
  pasos:[
    "Media pizza: 200 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "444 kcal y 2.4 g de sal la media pizza. Son el 25% de tus calorías del día y el 60% de tu tope de sal.",
    "La pizza entera (400 g) son 888 kcal y 4.8 g de sal: te pasarías del día de sal tú solo.",
    "19 g de proteína en la media pizza, que no está mal.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_tradizionale_pancetta_delicata", n:"Media pizza Tradizionale Pancetta Delicata (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_tradizionale_pancetta_delicata",c:195}],
  pasos:[
    "Media pizza: 195 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "464 kcal y 2.15 g de sal la media pizza. Son el 26% de tus calorías del día y el 54% de tu tope de sal.",
    "La pizza entera (390 g) son 928 kcal y 4.29 g de sal: te pasarías del día de sal tú solo.",
    "19 g de proteína en la media pizza, que no está mal.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_tradizionale_mozzarella_e_pesto", n:"Media pizza Tradizionale Mozzarella e Pesto (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_tradizionale_mozzarella_e_pesto",c:192.5}],
  pasos:[
    "Media pizza: 192.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "454 kcal y 1.81 g de sal la media pizza. Son el 26% de tus calorías del día y el 45% de tu tope de sal.",
    "La pizza entera (385 g) son 909 kcal y 3.62 g de sal: te pasarías del día de sal tú solo.",
    "17 g de proteína en la media pizza, que no está mal.",
    "Con 0.94 g de sal por 100 g es de las MENOS saladas del catálogo de Dr. Oetker. Ninguna baja de 0,89.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
...
{
  id:"cap_do_tradizionale_spinaci_e_ricotta", n:"Media pizza Tradizionale Spinaci e Ricotta (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_tradizionale_spinaci_e_ricotta",c:207.5}],
  pasos:[
    "Media pizza: 207.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "423 kcal y 2.01 g de sal la media pizza. Son el 24% de tus calorías del día y el 50% de tu tope de sal.",
    "La pizza entera (415 g) son 847 kcal y 4.03 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Con 0.97 g de sal por 100 g es de las MENOS saladas del catálogo de Dr. Oetker. Ninguna baja de 0,89.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
...
{
  id:"cap_do_la_mia_grande_4_formaggi", n:"Media pizza La Mia Grande 4 Formaggi (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_la_mia_grande_4_formaggi",c:200}],
  pasos:[
    "Media pizza: 200 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "486 kcal y 2.6 g de sal la media pizza. Son el 27% de tus calorías del día y el 65% de tu tope de sal.",
    "La pizza entera (400 g) son 972 kcal y 5.2 g de sal: te pasarías del día de sal tú solo.",
    "22 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Ojo con la gama: Casa di Mama y La Mia Grande pesan más que las Ristorante, así que aunque la sal por 100 g sea parecida, la media pizza siempre pasa de 2,2 g.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
...
{
  id:"cap_do_la_mia_grande_prosciutto_e_formagg", n:"Media pizza La Mia Grande Prosciutto e Formaggi (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_la_mia_grande_prosciutto_e_formagg",c:200}],
  pasos:[
    "Media pizza: 200 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "438 kcal y 2.6 g de sal la media pizza. Son el 25% de tus calorías del día y el 65% de tu tope de sal.",
    "La pizza entera (400 g) son 876 kcal y 5.2 g de sal: te pasarías del día de sal tú solo.",
    "22 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Ojo con la gama: Casa di Mama y La Mia Grande pesan más que las Ristorante, así que aunque la sal por 100 g sea parecida, la media pizza siempre pasa de 2,2 g.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
...
{
  id:"cap_do_la_mia_grande_tonno_e_cipolle", n:"Media pizza La Mia Grande Tonno e Cipolle (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_la_mia_grande_tonno_e_cipolle",c:207.5}],
  pasos:[
    "Media pizza: 207.5 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "440 kcal y 2.49 g de sal la media pizza. Son el 25% de tus calorías del día y el 62% de tu tope de sal.",
    "La pizza entera (415 g) son 880 kcal y 4.98 g de sal: te pasarías del día de sal tú solo.",
    "25 g de proteína en la media pizza, que no está mal.",
    "Ojo con la gama: Casa di Mama y La Mia Grande pesan más que las Ristorante, así que aunque la sal por 100 g sea parecida, la media pizza siempre pasa de 2,2 g.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
},
{
  id:"cap_do_la_mia_grande_rucola", n:"Media pizza La Mia Grande Rucola (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_la_mia_grande_rucola",c:205}],
  pasos:[
    "Media pizza: 205 g de la pizza entera.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "418 kcal y 2.26 g de sal la media pizza. Son el 23% de tus calorías del día y el 56% de tu tope de sal.",
    "La pizza entera (410 g) son 836 kcal y 4.51 g de sal: te pasarías del día de sal tú solo.",
    "20 g de proteína en la media pizza, que no está mal.",
    "Ojo con la gama: Casa di Mama y La Mia Grande pesan más que las Ristorante, así que aunque la sal por 100 g sea parecida, la media pizza siempre pasa de 2,2 g.",
    "Peso, macros y sal son de la etiqueta española. Las CALORÍAS están calculadas a partir de esos macros, porque la web de Dr. Oetker no las publica: el método acierta con menos de 3 kcal en las pizzas que sí las traen."
  ]
...
{
  id:"cap_do_rustica_cheese_deluxe", n:"Media pizza Rustica Cheese Deluxe (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_rustica_cheese_deluxe",c:138.75}],
  pasos:[
    "Media pizza: 138.75 g de una del pack de dos.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "362 kcal y 1.35 g de sal la media pizza. Son el 20% de tus calorías del día y el 34% de tu tope de sal.",
    "La pizza entera (277.5 g) son 724 kcal y 2.69 g de sal: te pasarías del día de sal tú solo.",
    "17 g de proteína en la media pizza, que no está mal.",
    "Con 0.97 g de sal por 100 g es de las MENOS saladas del catálogo de Dr. Oetker. Ninguna baja de 0,89.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
...
{
  id:"cap_do_rustica_royale", n:"Media pizza Rustica Royale (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_rustica_royale",c:143.75}],
  pasos:[
    "Media pizza: 143.75 g de una del pack de dos.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "312 kcal y 1.44 g de sal la media pizza. Son el 18% de tus calorías del día y el 36% de tu tope de sal.",
    "La pizza entera (287.5 g) son 624 kcal y 2.88 g de sal: te pasarías del día de sal tú solo.",
    "17 g de proteína en la media pizza, que no está mal.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_rustica_ham_cheese", n:"Media pizza Rustica Ham & Cheese (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_rustica_ham_cheese",c:136.25}],
  pasos:[
    "Media pizza: 136.25 g de una del pack de dos.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "361 kcal y 1.5 g de sal la media pizza. Son el 20% de tus calorías del día y el 37% de tu tope de sal.",
    "La pizza entera (272.5 g) son 722 kcal y 3 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
},
{
  id:"cap_do_rustica_double_pepperoni_cheddar_y", n:"Media pizza Rustica Double Pepperoni Cheddar y Mozzarella (Dr. Oetker)",
  rev:1,
  tipo:["comida","cena"], grupo:"capricho", raciones:1, min:20, tools:["airfryer"],
  ing:[{i:"do_rustica_double_pepperoni_cheddar_y",c:141.25}],
  pasos:[
    "Media pizza: 141.25 g de una del pack de dos.",
    "En la freidora de aire, 180 \u00b0C unos 12-14 minutos, sin precalentar. Si entera no cabe en la cesta, es justo lo que tiene de bueno partirla."
  ],
  trucos:[
    "386 kcal y 1.84 g de sal la media pizza. Son el 22% de tus calorías del día y el 46% de tu tope de sal.",
    "La pizza entera (282.5 g) son 771 kcal y 3.67 g de sal: te pasarías del día de sal tú solo.",
    "16 g de proteína en la media pizza, que no está mal.",
    "Con 1.3 g de sal por 100 g es de las MÁS saladas de su catálogo.",
    "Todo de la etiqueta española oficial de Dr. Oetker."
  ]
...
{
  id:"pan_ortiz_mesa", n:"Pan tostado Ortiz (3 rebanadas)",
  rev:1,
  tipo:["comida","cena"], grupo:"desayuno", raciones:1, min:1, tools:["sin-cocinar"],
  ing:[{i:"pan_ortiz",c:3}],
  pasos:[
    "Tres rebanadas de pan tostado Ortiz."
  ],
  trucos:[
    "129 kcal y 0,45 g de sal las tres rebanadas. Tomándolo en comida y cena son 0,91 g de sal al día.",
    "Es el pan que tenías antes del 22 de septiembre. Se queda aquí por si lo quieres puntualmente, pero el panecillo sin sal hace lo mismo con 65 veces menos sal.",
    "Si vuelves a él, el ajuste natural es bajar de 3 rebanadas a 2 en una de las dos tomas: son 0,15 g de sal menos al día.",
    "Mira siempre la etiqueta del pan tostado: el rango del mercado va de 0,2 a 1,8 g de sal por 100 g, y a simple vista son idénticos."
  ]
}
];
