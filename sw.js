...
var CACHE = "menu-semanal-v255";
var FICHEROS = [
  "./", "./index.html", "./css/estilos.css?v=255",
  "./js/util.js?v=255", "./js/almacen.js?v=255", "./js/github.js?v=255", "./js/app.js?v=255",
  "./datos/ingredientes.js?v=255", "./datos/recetas.js?v=255", "./datos/nuevos.js?v=255", "./datos/hogar.js?v=255", "./datos/plantillas.js?v=255", "./datos/actividades.js?v=255", "./datos/plan.js?v=255", "./datos/mi-cocina.json", "./datos/mis-gustos.json", "./js/entrenamiento.js?v=255", "./js/actividad-khb.js?v=255", "./css/actividad-khb.css?v=255",
  "./iconos/khb/1-arbol-pulso.webp", "./iconos/khb/2-frutas-tenedor.webp", "./iconos/khb/3-pesas-corredor.webp", "./iconos/khb/4-agua.webp", "./iconos/khb/5-sueno.webp", "./iconos/khb/6-zapatillas.webp", "./iconos/khb/7-yoga.webp", "./iconos/khb/8-recetario.webp", "./iconos/khb/9-podio.webp", "./iconos/khb/10-bici.webp", "./iconos/khb/11-montana.webp", "./media/cartel-h.webp", "./media/cartel-v.webp", "./manifest.webmanifest", "./iconos/icono.svg", "./iconos/animo/en-su-sitio.webp?v=255", "./iconos/animo/en-su-sitio-comic.webp?v=255", "./iconos/animo/pasado.webp?v=255", "./iconos/animo/pasado-comic.webp?v=255", "./iconos/animo/corto.webp?v=255", "./iconos/animo/corto-comic.webp?v=255", "./iconos/animo/fuerza.webp?v=255", "./iconos/animo/fuerza-comic.webp?v=255", "./iconos/animo/descanso.webp?v=255", "./iconos/animo/descanso-comic.webp?v=255", "./iconos/animo/en-marcha.webp?v=255", "./iconos/animo/en-marcha-comic.webp?v=255", "./iconos/animo/sem-espera.webp?v=255", "./iconos/animo/sem-azul.webp?v=255", "./iconos/animo/sem-verde.webp?v=255", "./iconos/animo/sem-ambar.webp?v=255", "./iconos/animo/sem-rojo.webp?v=255"
];
