...
var CACHE = "menu-semanal-v85";
var FICHEROS = [
  "./", "./index.html", "./css/estilos.css?v=85",
  "./js/util.js?v=85", "./js/almacen.js?v=85", "./js/github.js?v=85", "./js/app.js?v=85",
  "./datos/ingredientes.js?v=85", "./datos/recetas.js?v=85", "./datos/plantillas.js?v=85", "./datos/actividades.js?v=85", "./datos/plan.js?v=85", "./js/entrenamiento.js?v=85", "./js/actividad-khb.js?v=85", "./css/actividad-khb.css?v=85",
